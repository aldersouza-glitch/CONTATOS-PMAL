  ...
  return (
    <div className="flex h-screen bg-[#f8fafc] overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full">
        ...
        <header className="min-h-[120px] lg:h-40 bg-[#004085] flex flex-col justify-center px-4 lg:px-10 relative z-10 shadow-lg">
          <div className="max-w-4xl w-full mx-auto">
            <div className="flex items-center gap-4 mb-3">
              ...
              <h2 className="text-white text-[10px] lg:text-xs font-bold uppercase tracking-widest opacity-80">Pesquisar Contatos Oficiais</h2>
            </div>
            <div className="relative group">
              <span className="absolute inset-y-0 left-0 flex items-center pl-4 lg:pl-5 pointer-events-none text-blue-400 group-focus-within:text-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
              </span>
              <input
                type="text"
                placeholder="Nome, unidade, cargo ou telefone..."
                className="w-full pl-11 lg:pl-14 pr-4 lg:pr-6 py-3 lg:py-4 bg-white border-none rounded-xl lg:rounded-2xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/30 transition-all text-sm lg:text-base shadow-xl"
                value={searchTerm}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {filteredOfficers.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 lg:py-24 text-center px-4">
                ...
                <p className="text-slate-400 mt-2 font-medium text-sm lg:text-base">Refine sua busca ou verifique outra categoria no menu lateral.</p>
              </div>
            )}
          </div>
        </main>

...
export const OFFICER_DATA: Officer[] = [
  ...
  { id: 'cg-2', category: 'Comando', unit: 'GCG', rank: 'MAJ', matricula: '117528', name: 'ADEILSON LINS DE CARVALHO', role: 'Chefe de Gabinete do Comandante Geral', contact: '8823-8269' },
  ...
  { id: 'cg-5', category: 'Comando', unit: 'GCG', rank: 'MAJ', matricula: '1206842', name: 'DAVID DELEON LOPES', role: 'Chefe da SPO', contact: '98867-7861' },
  ...
  { id: 'emg-1', category: 'EMG', unit: 'EMG', rank: 'CEL', matricula: '89346', name: 'CARLOS ALBERTO LUNA', role: 'Chefe do EMG', contact: '99318-9412' },
  { id: 'emg-2', category: 'EMG', unit: 'EMG', rank: 'MAJ', matricula: '117820', name: 'SERGIO HENRIQUE LIMA DOS SANTOS', role: 'Subchefe do EMG', contact: '98702-0846' },
  { id: 'emg-3', category: 'EMG', unit: 'EMG', rank: 'MAJ', matricula: '117595', name: 'CICERO SERCUNDINO DA SILVA', role: 'Chefe da 1ª Seção (EMG)', contact: '99120-0867' },
  ...
  { id: 'emg-5', category: 'EMG', unit: 'EMG', rank: 'MAJ', matricula: '113301', name: 'JORGE RODRIGUES DE MORAIS JUNIOR', role: 'Chefe da 3ª Seção (EMG)', contact: '99125-0056' },
  { id: 'emg-6', category: 'EMG', unit: 'EMG', rank: 'MAJ', matricula: '116858', name: 'JOSE PETRONIO PANTALEAO DOS SANTOS', role: 'Chefe da 4ª Seção (EMG)', contact: '99691-1953' },
  ...
  { id: 'cor-2', category: 'Administrativo', unit: 'CORREG', rank: 'MAJ', matricula: '102784', name: 'CLAUDIO JOSE DA SILVA', role: 'Subcorregedor Geral', contact: '99157-7657' },
  ...
  { id: 'dir-10', category: 'Diretorias', unit: 'DCS', rank: 'TC', matricula: '121096', name: 'MIZAEL LEITE PESSOA JUNIOR', role: 'Subdiretor de Comunicação Social', contact: '98805-2920' },
  ...
  { id: 'dir-12', category: 'Diretorias', unit: 'DEIP', rank: 'MAJ', matricula: '121100', name: 'ANTONIO UMBELINO', role: 'Subdiretor de Ensino, Instrução e Pesquisa', contact: '98858-7495' },
  ...
  { id: 'dir-15', category: 'Diretorias', unit: 'DPS', rank: 'TC', matricula: '117846', name: 'THAYRONILSON EMERY DOS SANTOS', role: 'Diretor de Proteção Social', contact: '98825-9120' },
  { id: 'dir-16', category: 'Diretorias', unit: 'DPS', rank: 'TC', matricula: '120928', name: 'JOSILEIDE ROMEIRO', role: 'Subdiretor de Proteção Social', contact: '988396426' },
  { id: 'dir-17', category: 'Diretorias', unit: 'DS', rank: 'CEL', matricula: '109282', name: 'SILVIO DE BRITO MOURA', role: 'Diretor de Saúde', contact: '99992-6556' },
  { id: 'dir-18', category: 'Diretorias', unit: 'DS', rank: 'CEL', matricula: '296899', name: 'SIMUR MENDES LAGES', role: 'Subdiretor de Saúde', contact: '98898-2667' },
  { id: 'dir-19', category: 'Diretorias', unit: 'CIA', rank: 'TC', matricula: '113530', name: 'JEFFERSON LUIZ TAVARES DA', role: 'CIA', contact: '99647-5758' },
  ...
  { id: 'm-17', category: 'Metropolitana', unit: '2ª CPM/I', rank: 'CAP', matricula: '98664298', name: 'CINIRA RAMOS DE', role: 'Subcomandante 2ª CPM/I', contact: '98841-1041' },
  { id: 'm-18', category: 'Metropolitana', unit: '4ª CPM/I', rank: 'CAP', matricula: '498513', name: 'MICHEL LINS PIMENTEL', role: 'Comandante 4ª CPM/I – Marechal Deodoro', contact: '99933-0593' },
  { id: 'm-19', category: 'Metropolitana', unit: '4ª CPM/I', rank: '1º TEN', matricula: '13706', name: 'AUDERAN VIRTUOSO', role: 'Subcomandante 4ª CPM/I', contact: '99194-8203' },
  ...
  { id: 'ser-7', category: 'Sertão', unit: '6ª CPM/I', rank: 'CAP', matricula: '1643', name: 'EDUARDO HENRIQUE', role: 'Comandante 6ª CPM/I – Batalha', contact: '99835-0637' },
  { id: 'ser-8', category: 'Sertão', unit: '6ª CPM/I', rank: '1º TEN', matricula: '44261', name: 'JAILSON COSTA DE', role: 'Subcomandante 6ª CPM/I', contact: '99905-6401' },
  ...
  { id: 'agr-4', category: 'Agreste', unit: '3º BPM', rank: 'MAJ', matricula: '1207474', name: 'EMANOEL PEDRO SANTOS SILVA', role: 'Subcomandante 3º BPM', contact: '99900-7800' },
  ...
  { id: 'nzm-5', category: 'Norte/ZM', unit: '6º BPM', rank: 'TC', matricula: '1207113', name: 'ALEANDRO FERREIRA CAITANO', role: 'Comandante 6º BPM – Maragogi', contact: '99915-8301' },
  ...
  { id: 'nzm-10', category: 'Norte/ZM', unit: '8ª CPM/I', rank: '1º TEN', matricula: '442455-92', name: 'CHARLANDISON RODRIGUES DOS SANTOS', role: 'Subcomandante 8ª CPM/I', contact: '99182-4791' },
  ...
  { id: 'sul-8', category: 'Sul', unit: '9ª CPM/I', rank: '1º TEN', matricula: '10669', name: 'RENATO BATISTA', role: 'Subcomandante 9ª CPM/I', contact: '9935-5811' },
  { id: 'sul-9', category: 'Sul', unit: '10ª CPM/I', rank: 'MAJ', matricula: '1206850', name: 'ANTONIO HENRIQUE DIAS COSTA', role: 'Comandante 10ª CPM/I – Teotônio Vilela', contact: '99694-8206' },
  ...
  { id: 'esp-6', category: 'Especializado', unit: 'BPTran', rank: 'MAJ', matricula: '1423916', name: 'GILVANO SILVA SANTOS JUNIOR', role: 'Subcomandante BPTran', contact: '98861-6675' },
  ...
  { id: 'esp-11', category: 'Especializado', unit: 'CPM/I-Faz', rank: 'CAP', matricula: '98667890', name: 'VICTOR SANTOS', role: 'Comandante CPM/I-Faz', contact: '99621-0887' },
  ...
  { id: 'mis-7', category: 'Missões', unit: 'RPMon', rank: 'TC', matricula: '1207318', name: 'DIEGO HENRIQUE BEZERRA VIEIRA', role: 'Comandante RPMon', contact: '99644-8691' },
  ...
  { id: 'mis-12', category: 'Missões', unit: 'CPChoque', rank: '1º TEN', matricula: '44288', name: 'JOSE FERNANDO DE', role: 'Subcomandante CPChoque', contact: '99304-3635' },
  ...
  { id: 'esc-4', category: 'Diretorias', unit: 'CFAP', rank: 'MAJ', matricula: '1207172', name: 'GEISON FRANCA DA', role: 'Subcomandante CFAP', contact: '98837-5244' },
  ...
  { id: 'esc-9', category: 'Diretorias', unit: 'CPM-Int', rank: 'MAJ', matricula: '1207580', name: 'BRUNO EUCLIDES DOS', role: 'Subcomandante Colégio Militar Interior', contact: '98895-0206' },
  ...
  { id: 'out-21', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '89826', name: 'KLINGERMARIO SILVA ARAUJO', role: 'Oficial', contact: '98145-0243' },
  { id: 'out-22', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '101737', name: 'ALEXANDRE RAMOS BRAGA', role: 'Oficial', contact: '99902-6499' },
  { id: 'out-23', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '14567', name: 'MELRISON SILVA DE LIMA', role: 'Oficial', contact: '99621-3343' },
  { id: 'out-24', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '116866', name: 'ELIEZER ROOSEVELT MENDONÇA LISBOA', role: 'Oficial', contact: '99983-0900' },
  { id: 'out-25', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '113476', name: 'JEORGE PEREIRA SILVA', role: 'Oficial', contact: '99650-8608' },
  { id: 'out-26', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1206532', name: 'DAVID DURVAL PEREIRA DA SILVA', role: 'Oficial', contact: '99655-2743' },
  { id: 'out-27', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '98653067', name: 'DIEGO MAHATMA DE MORAES', role: 'Oficial', contact: '98736-4780' },
  { id: 'out-28', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '120979', name: 'EDSON CARLOS BARROS CABRAL DE MELO', role: 'Oficial', contact: '98701-0551' },
  { id: 'out-29', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '16870', name: 'ZAQUEU DE LIMA OLIVEIRA FILHO', role: 'Oficial', contact: '99671-0487' },
  { id: 'out-30', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '113590', name: 'JOSE WILSON DOS SANTOS', role: 'Oficial', contact: '99977-1666' },
  { id: 'out-31', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '120960', name: 'MARCOS ANTONIO COSTA', role: 'Oficial', contact: '98178-0098' },
  { id: 'out-32', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1206907', name: 'CARLOS EDUARDO CAVALCANTE SANTOS', role: 'Oficial', contact: '99615-0002' },
  { id: 'out-33', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '101699', name: 'FLAVIO AUGUSTO SILVA BARROS', role: 'Oficial', contact: '99973-0821' },
  { id: 'out-34', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '14575', name: 'PEDRO AURELIO TEIXEIRA LIMA GOMES', role: 'Oficial', contact: '99641-0687' },
  { id: 'out-35', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1200461', name: 'JOSE ALEXANDRE DOS SANTOS PORCIUNCULA', role: 'Oficial', contact: '99647-1494' },
  { id: 'out-36', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '117790', name: 'PAULO EDUARDO ACIOLY WANDERLEY', role: 'Oficial', contact: '99117-9607' },
  { id: 'out-37', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '120499', name: 'BRUNO DE LIMA LINS', role: 'Oficial', contact: '98818-8040' },
  { id: 'out-38', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '120480', name: 'SILVIO CARVALHO VIEIRA', role: 'Oficial', contact: '98866-6594' },
  { id: 'out-39', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1200615', name: 'FRANCIS DA MOTA SANTOS', role: 'Oficial', contact: '99964-7760' },
  { id: 'out-40', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '98667823', name: 'ERIQUE CAVALCANTE MEDEIROS DA HORA', role: 'Oficial', contact: '99999-2227' },
  { id: 'out-41', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '5525', name: 'VAGNER MARTILIANO DE OLIVEIRA', role: 'Oficial', contact: '98884-3787' },
  { id: 'out-42', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '1392', name: 'DIEGO BRUNO BARBOSA SANTOS', role: 'Oficial', contact: '98867-7180' },
  { id: 'out-43', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '117544', name: 'OSIAS ALEXANDRE FERREIRA', role: 'Oficial', contact: '99198-9817' },
  { id: 'out-44', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1206648', name: 'DANILVA CLAUDIA ALVINO DA SILVA', role: 'Oficial', contact: '98825-1122' },
  { id: 'out-45', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '1206915', name: 'DAVI DE MELO MOTA', role: 'Oficial', contact: '98868-5509' },
  { id: 'out-46', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '83758', name: 'CICERO JOSE NAVARRO FERRO', role: 'Oficial', contact: '98823-8269' },
  { id: 'out-47', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '102555', name: 'SERGIO JOSE GALVAO ALVES', role: 'Oficial', contact: '99671-7116' },
  { id: 'out-48', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '120863', name: 'DJANE MENEZES DOS SANTOS MILHOMES', role: 'Oficial', contact: '98835-3368' },
  { id: 'out-49', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '114014', name: 'CLOVES DO NASCIMENTO CORREIA', role: 'Oficial', contact: '99644-8091' },
  { id: 'out-50', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '94757', name: 'MARCELO DA FONSECA CARNAUBA', role: 'Oficial', contact: '99999-0059' },
  { id: 'out-51', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '102857', name: 'BENJAMIM ANDRÉ SOUZA MORAIS', role: 'Oficial', contact: '98710-0076' },
];

...
export const OFFICER_DATA: Officer[] = [
  ...
  { id: 'out-15', category: 'Outros', unit: 'PMAL', rank: 'CEL', matricula: '89265', name: 'JEFFERSON CLAYTON NASCIMENTO DE ASSUNCAO', role: 'Oficial', contact: '98882-2826' },
  { id: 'out-16', category: 'Outros', unit: 'PMAL', rank: 'CEL', matricula: '82082', name: 'GERONIMO CARLOS DO NASCIMENTO', role: 'Oficial', contact: '98830-0062' },
  { id: 'out-17', category: 'Outros', unit: 'PMAL', rank: 'CEL', matricula: '57789', name: 'WILSON DA SILVA', role: 'Oficial', contact: '99341-4729' },
  { id: 'out-18', category: 'Outros', unit: 'PMAL', rank: 'CEL', matricula: '89869', name: 'MARCOS SAMPAIO LIMA', role: 'Oficial', contact: '98812-5217' },
  { id: 'out-19', category: 'Outros', unit: 'PMAL', rank: 'CEL', matricula: '89818', name: 'JOSE BERNARDO DA SILVA', role: 'Oficial', contact: '99982-2939' },
  { id: 'out-20', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '89826', name: 'KLINGERMARIO SILVA ARAUJO', role: 'Oficial', contact: '98145-0243' },
  { id: 'out-21', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '101737', name: 'ALEXANDRE RAMOS BRAGA', role: 'Oficial', contact: '99902-6499' },
  { id: 'out-22', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '14567', name: 'MELRISON SILVA DE LIMA', role: 'Oficial', contact: '99621-3343' },
  { id: 'out-23', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '116866', name: 'ELIEZER ROOSEVELT MENDONÇA LISBOA', role: 'Oficial', contact: '99983-0900' },
  { id: 'out-24', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '113476', name: 'JEORGE PEREIRA SILVA', role: 'Oficial', contact: '99650-8608' },
  { id: 'out-25', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1206532', name: 'DAVID DURVAL PEREIRA DA SILVA', role: 'Oficial', contact: '99655-2743' },
  { id: 'out-26', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '98653067', name: 'DIEGO MAHATMA DE MORAES', role: 'Oficial', contact: '98736-4780' },
  { id: 'out-27', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '120979', name: 'EDSON CARLOS BARROS CABRAL DE MELO', role: 'Oficial', contact: '98701-0551' },
  { id: 'out-28', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '16870', name: 'ZAQUEU DE LIMA OLIVEIRA FILHO', role: 'Oficial', contact: '99671-0487' },
  { id: 'out-29', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '113590', name: 'JOSE WILSON DOS SANTOS', role: 'Oficial', contact: '999771666' },
  { id: 'out-30', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '120960', name: 'MARCOS ANTONIO COSTA', role: 'Oficial', contact: '98178-0098' },
  { id: 'out-31', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1206907', name: 'CARLOS EDUARDO CAVALCANTE SANTOS', role: 'Oficial', contact: '99615-0002' },
  { id: 'out-32', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '101699', name: 'FLAVIO AUGUSTO SILVA BARROS', role: 'Oficial', contact: '99973-0821' },
  { id: 'out-33', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '14575', name: 'PEDRO AURELIO TEIXEIRA LIMA GOMES', role: 'Oficial', contact: '99641-0687' },
  { id: 'out-34', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1200461', name: 'JOSE ALEXANDRE DOS SANTOS PORCIUNCULA', role: 'Oficial', contact: '99647-1494' },
  { id: 'out-35', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '117790', name: 'PAULO EDUARDO ACIOLY WANDERLEY', role: 'Oficial', contact: '99117-9607' },
  { id: 'out-36', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '120499', name: 'BRUNO DE LIMA LINS', role: 'Oficial', contact: '98818-8040' },
  { id: 'out-37', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '120480', name: 'SILVIO CARVALHO VIEIRA', role: 'Oficial', contact: '98866-6594' },
  { id: 'out-38', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1200615', name: 'FRANCIS DA MOTA SANTOS', role: 'Oficial', contact: '99964-7760' },
  { id: 'out-39', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '98667823', name: 'ERIQUE CAVALCANTE MEDEIROS DA HORA', role: 'Oficial', contact: '99999-2227' },
  { id: 'out-40', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '5525', name: 'VAGNER MARTILIANO DE OLIVEIRA', role: 'Oficial', contact: '98884-3787' },
  { id: 'out-41', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '1392', name: 'DIEGO BRUNO BARBOSA SANTOS', role: 'Oficial', contact: '98867-7180' },
  { id: 'out-42', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '117544', name: 'OSIAS ALEXANDRE FERREIRA', role: 'Oficial', contact: '99198-9817' },
  { id: 'out-43', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '1206648', name: 'DANILVA CLAUDIA ALVINO DA SILVA', role: 'Oficial', contact: '98825-1122' },
  { id: 'out-44', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '1206915', name: 'DAVI DE MELO MOTA', role: 'Oficial', contact: '98868-5509' },
  { id: 'out-45', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '83758', name: 'CICERO JOSE NAVARRO FERRO', role: 'Oficial', contact: '98823-8269' },
  { id: 'out-46', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '102555', name: 'SERGIO JOSE GALVAO ALVES', role: 'Oficial', contact: '99671-7116' },
  { id: 'out-47', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '120863', name: 'DJANE MENEZES DOS SANTOS MILHOMES', role: 'Oficial', contact: '98835-3368' },
  { id: 'out-48', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '114014', name: 'CLOVES DO NASCIMENTO CORREIA', role: 'Oficial', contact: '99644-8091' },
  { id: 'out-49', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '94757', name: 'MARCELO DA FONSECA CARNAUBA', role: 'Oficial', contact: '99999-0059' },
  { id: 'out-50', category: 'Outros', unit: 'PMAL', rank: 'CEL', matricula: '89982', name: 'MACIEL PANTALEAO SILVA', role: 'Oficial', contact: '98854-1619' },
  { id: 'out-51', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '102857', name: 'BENJAMIM ANDRÉ SOUZA MORAIS', role: 'Oficial', contact: '998710-0076' },
  { id: 'out-52', category: 'Outros', unit: 'PMAL', rank: '1º TEN', matricula: '1205064', name: 'MAURICIO ARAUJO ALMEIDA', role: 'Oficial', contact: '99906-7244' },
  { id: 'out-53', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '120723', name: 'MONICA VALÉRIA SAMPAIO VALOES DE LIMA', role: 'Oficial', contact: '99836-1342' },
  { id: 'out-54', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '98667785', name: 'AVNER AUGUSTO DE MORAES', role: 'Oficial', contact: '99612-0704' },
  { id: 'out-55', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '120839', name: 'ROBERTO SANTOS JUNIOR', role: 'Oficial', contact: '98885-9709' },
  { id: 'out-56', category: 'Outros', unit: 'PMAL', rank: 'MAJ', matricula: '121100', name: 'ANTONIO UMBELINO DOS SANTOS FILHO', role: 'Oficial', contact: '98858-7495' },
  { id: 'out-57', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '74969', name: 'EDUARDO JORGE DE OLIVEIRA COSTA', role: 'Oficial', contact: '99811-1707' },
  { id: 'out-58', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '113409', name: 'RIVALDO FARIAS DA SILVA', role: 'Oficial', contact: '98805-8325' },
  { id: 'out-59', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '1678', name: 'OSCAR DE FREITAS BEZERRA JUNIOR', role: 'Oficial', contact: '99129-0103' },
  { id: 'out-60', category: 'Outros', unit: 'PMAL', rank: 'TC', matricula: '116602', name: 'CARLOS ALBERTO CARDOSO DOS SANTOS', role: 'Oficial', contact: '98848-2313' },
  { id: 'out-61', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '19', name: 'MARIO DE FREITAS GONÇALVES CARNEIRO FILHO', role: 'Oficial', contact: '99601-4338' },
  { id: 'out-62', category: 'Outros', unit: 'PMAL', rank: 'CAP', matricula: '98664298', name: 'CINIRA RAMOS DE FREITAS', role: 'Oficial', contact: '98841-1041' },
];
